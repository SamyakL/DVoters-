...
contract Voting{
    ...
    function newSeason(string memory nameOfSeason) public {
        require(ongoingSeason==false, "Another season is already going on! Wait for this season to get over");
    ...
    function addCandidate() public {
        ...
        require(voterAlready[msg.sender]==false,"The address is already participating as a voter!");
        require(ongoingSeason==true,"There is no season going on, wait till new season is started");
        require(block.timestamp<=timeOfDeployment + 300,"The time for registering candidates is over!");
    ...
    function addVoter() public {
        ...
        require(candidateAlready[msg.sender]==false,"The adress is already participating as a candidate!");
        require(ongoingSeason==true,"There is no season going on, wait till new season is started");
        require(block.timestamp<=timeOfDeployment + 300,"The time for registering voter is over!");
